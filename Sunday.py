...
def sendEmail(body="badminton court"):
    ...
    receiver_email_weilei = "weilei19960909@163.com"
    ...
    try:
        ...
        server.sendmail(sender_email, receiver_email_weilei, text)
        server.quit()
...
def query_and_send_email():
    ...
    headers = {
        ...
        'js_sign': 'OTg1YWRkNzc0ZjFmZjVjMTIxMzdiMGZkYmQ0YWMzZGE=',
    ...
    data = '{"venueId":"27","bookTime":"1710604800000"}'
